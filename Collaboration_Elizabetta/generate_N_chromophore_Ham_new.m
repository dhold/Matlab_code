...
sqm = cellfun(@rdivide,lambda,omegavib,'UniformOutput',false);
...
coupg = cellfun(cellfun(@sqrt,sqm),@times,omegavib);
...
if viblvls > 0 && ~isempty(omegavib)
 ...
 [Time_units,rho_vec,nn,total_prop_op]=multi_site_drude_and_brownian_HOM_3...
            ...
            numpoints,tendps,saveuptotier,use_reduced_mat,'saved_data_test4.mat');
