function  [rho_neq_g_t,rho_neq_e_t,rho_neq_fg_t] = doorway_prop_simple(...
          t1_rng,E_u_t,om_u_range,N,sz2,t_sep_rng,...
...
t1_rng = reshape(t1_rng,1,length(t1_rng)); %make horizontal
