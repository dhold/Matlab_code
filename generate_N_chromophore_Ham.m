...
viblvls = 3; %zero means no quantised vibration considered
...
lam_dru = 10; %amplitude of drude modes
gam_dru = 100; %width
...
cc1 = repmat(cc1,N,1); cc2R = repmat(cc2R,N,1); cc2I = repmat(cc2I,N,1); 
 ...
 [Time_units,rho_vec,nn,total_prop_op]=multi_site_drude_and_brownian_HOM...
            ...
            numpoints,tendps,Temp,saveonlyrho00,'saved_data_vibinc_weak_drude.mat');
