function [R_red,Ctilde, Gam_RF,Q_j] = redfield_calc_3(H_single,H_double...
...
Ctilde_re(lp,a,b) = Ctilde_re(lp,a,b) + sum(2*gam.*om0.^2.*lam.*deltaom./((om0.^2-deltaom^2).^2+deltaom^2*gam.^2));                              
