function [out1,t_range1,out2,t_range2,savehrarch] = reduced_HEOM_with_vib(input_state,t_end,...
                    Htot,QQ,cc_com,cc_acom,vv,Kap1,Kap2,numpoints,tot_vib,save_to_tier)
...
N = length(cc_com);
H_g = H_tot(1:tot_vib,1:tot_vib);
H_e = Htot(tot_vib+1:tot_vib*(N+1),tot_vib+1:tot_vib*(N+1)); %reduce size
