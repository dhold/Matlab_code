function [av_set1,av_set2 ,av_set3] = ori_av_3rd_order(mu,m,Q,k,v,s,save_sep)
...
% s is length in dim2 which is plus or minus 1, in dim 1 it is the length
% of k in dim 3 (number of beam configurations included)
